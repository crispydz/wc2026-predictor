    ...
    <div className="card" style={{ overflow: 'hidden' }}>
      ...
      <div onClick={() => setOpen(!open)} style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <div>
            <div style={{ fontSize: 10, color: 'var(--text3)', fontWeight: 700,
                          letterSpacing: '0.08em', marginBottom: 6 }}>GROUPE</div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          {upsets > 0 && (
            <span className="badge badge-red">⚡ {upsets} serré{upsets > 1 ? 's' : ''}</span>
          )}
        ...
        {standing.map((team, i) => {
          ...
          return (
            <div key={team} style={{
              ...
              <span style={{ fontSize: 14, fontWeight: 600, color: 'var(--text1)', flex: 1 }}>
                {team}
              </span>
      ...
      {open && (
        <div style={{ padding: '16px 20px', borderTop: '1px solid var(--border)',
                      background: 'var(--surface1)', display: 'flex',
